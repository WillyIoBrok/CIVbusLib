...
{ uint8_t idx;
	...
	for (idx=0;idx<CIVresultBufSize;idx++)	// no valid address registered yet
...
//static uint8_t CIV::rxBuffer[];							// dynamisch ist auch ok !!!

//static CIVresult_t CIV::CIVresultBuf[];
//static uint8_t 		 CIV::CIVresultBufIdx; 
//static uint8_t		 CIV::knownAddress[];
